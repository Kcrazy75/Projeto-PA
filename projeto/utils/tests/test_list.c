...
void test_iterator() {
    TEST_ASSERT_FALSE(list_iterator_has_next(list));
    insert_numbers(1, 5);
    list_iterator_start(list);
    TEST_ASSERT_TRUE(list_iterator_has_next(list));
    TEST_ASSERT_EQUAL(1, *(int*)list_iterator_get_next(list));
    TEST_ASSERT_TRUE(list_iterator_has_next(list));
    TEST_ASSERT_EQUAL(2, *(int*)list_iterator_get_next(list));
    TEST_ASSERT_TRUE(list_iterator_has_next(list));
    TEST_ASSERT_EQUAL(3, *(int*)list_iterator_get_next(list));
    TEST_ASSERT_TRUE(list_iterator_has_next(list));
    TEST_ASSERT_EQUAL(4, *(int*)list_iterator_get_next(list));
    TEST_ASSERT_TRUE(list_iterator_has_next(list));
    TEST_ASSERT_EQUAL(5, *(int*)list_iterator_get_next(list));
    TEST_ASSERT_FALSE(list_iterator_has_next(list));
}
